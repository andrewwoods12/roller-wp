<?php
if (!class_exists('HideTitle')) {

    class HideTitle {

        private $slug = 'toggle_title';
        ...
        public function build_box($post) {
            ...
            ?>
            <label>
                <input type="checkbox" name="<?php echo $this->slug; ?>" <?php echo $checked; ?> /> Hide the title on
                singular page views.</label>
            <?php
    ...
    $HideTitle = new HideTitle;

} // !class_exists( 'HideTitle' )